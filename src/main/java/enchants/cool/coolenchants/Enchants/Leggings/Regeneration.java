...
public class Regeneration {
    ...
    public static void Regen() {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (Player Player : Bukkit.getOnlinePlayers()) {
                    ...
                    ArrayList<String> Lore = EnchantHelper.GetEnchants(Leggings.lore());
                    if (!Lore.contains("Regeneration")) { return; }
                    Integer EnchantLevel = EnchantHelper.GetEnchantLevels(Leggings.lore()).get("Regeneration");
        ...
        }.runTaskTimer(CoolEnchants.GetPlugin(), 0L, 40L);
    }
}
